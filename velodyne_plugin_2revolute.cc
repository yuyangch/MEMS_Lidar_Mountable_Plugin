...
namespace gazebo
{
  ...
  class VelodynePlugin : public ModelPlugin
  {
    ...
    public: virtual void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
    {
      ...
      this->pid = common::PID(0.1, 0, 0.1);
      this->pid1 = common::PID(0.1, 0, 0.1);
    ...
    public: void SetPosition(const double &_x,const double &_y)
    {
      // Set the joint's target velocity.
		std::cout<<"setjoinposition\n"<<_x<<" "<<_y<<"\n";
      //
      this->model->GetJointController()->SetPositionTarget(
          this->joint->GetScopedName(), _x);
      // this->model->GetJointController()->SetPositionTarget(
      //    this->joint1->GetScopedName(), _y); 
       //this->joint->SetPosition(0,_x);     
      //this->joint1->SetPosition(0,_y);
    }
